  ...
  return (
    ...
    >
      <button
        ...
        className="pointer-events-auto animate-in flex w-full max-w-sm items-center gap-3 rounded-2xl border border-border/80 bg-surface px-4 py-3 text-left shadow-xl backdrop-blur-md transition-colors hover:bg-surface-hover cursor-pointer"
      >
